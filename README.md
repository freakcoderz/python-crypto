...
These files are intended to function as a multi-functional tipbot for Aevo Coin.

# Requirements
* discord.py installed
* Python 3.6+
* A MySQL database
* The Aevo wallet w/ RPC enabled.
...
```
## Install Discord Library, Need to update to a newer version that is supported
Install the discord library used for the bot
```
python3 -m pip install -U discord.py (no longer supported)
```
